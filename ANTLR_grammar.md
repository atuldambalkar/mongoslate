Mongoslate ANTLR LL(`*`) grammar for parsing SQL-like query statements for MongoDB.

# Introduction #

Following is the Mongoslate ANTLR grammar which can parse SQL-like statements and builds the Tree. It has quite a few MongoDB specific keywords/constructs.
