...
/**
 * Class to represent unary logical negation expression.
 * 
 * @author Atul M Dambalkar (atul@entrib.com)
 */
public class NegationExpression implements SignExpression, ExpressionVisitable {
    ...
    public ExpressionTypeEnum getExpressionTypeEnum() {
        return ExpressionTypeEnum.Negation;
    }
