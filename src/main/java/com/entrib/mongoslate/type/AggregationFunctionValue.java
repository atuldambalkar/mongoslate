 ...
 */
public class AggregationFunctionValue extends TagValue {

    private AggregationFunctionEnum aggregationFunctionEnum;

    public AggregationFunctionValue() {
        super.setValueType(ValueType.AGGREGATION_FUNCTION);
    }

    public AggregationFunctionValue(AggregationFunctionEnum aggregationFunctionEnum, String value) {
        super(value);
        super.setValueType(ValueType.AGGREGATION_FUNCTION);
